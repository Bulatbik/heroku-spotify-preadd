            ...
            <div class="app">
                ...
                <div id="contentfadein" class="content-container">
                    ...
                    <div>
                        ...
                        <a class="buttonViewApple" onClick={(e) => this.signIn(e)} id="apple-music-authorize">
                            <img class="appleLogo" src="/AppleMusic.png" />
                            <button class="buttonApple" onClick={(e) => this.signIn(e)} id="apple-music-authorize-button">Pre-Add on Apple Music</button>
                        </a>
