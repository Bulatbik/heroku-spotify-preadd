...
//sub is 'subdomain', 'domain', type is 'com'
        var datares;
        let data =  await axios.post('https://endlss.herokuapp.com/createTheSite', {linkID:sub.toLowerCase()+"."+window.location.pathname.substring(1, window.location.pathname.indexOf('/')).toLowerCase(), location:location.data.city+"-"+location.data.country_name})
